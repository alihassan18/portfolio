                            ...
                            <div className="col-span-12 space-y-2.5">
                                <div className="lg:mr-16">
                                    <p className="text-gray-lite dark:text-color-910 leading-7">
                                        I&apos;m a seasoned MERN Stack, Web3,
                                        and Blockchain Developer with a proven
                                        track record in leading diverse
                                        blockchain projects. My professional
                                        journey has taken me through leading
                                        roles at Renesis Tech and MagnusMage,
                                        where I&apos;ve been instrumental in
                                        developing innovative blockchain
                                        solutions, including NFT marketplaces,
                                        token management systems, crypto
                                        wallets, blockchain explorers, and
                                        centralized exchanges.
                                    </p>
                                    <p className="text-gray-lite leading-7 mt-2.5 dark:text-color-910">
                                        I&apos;m well-versed in integrating
                                        advanced technologies like XUMM and IPFS
                                        to deliver enhanced user experiences.
                                        With a strong focus on innovation,
                                        quality, and best practices, I am always
                                        keen on leveraging my technical
                                        expertise to drive transformation in the
                                        blockchain space.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2 ">
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        ...
                                        tailored to meet specific business
                                        requirements.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        ...
                                        mobile and web applications using modern
                                        frameworks and technologies to provide
                                        seamless experiences across different
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        Developing and integrating blockchain
                                        solutions such as decentralized
                                        applications (dApps), smart contracts,
                                        and NFT marketplaces, leveraging
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        Creating user-centric NFT marketplaces
                                        with features for minting, buying,
                                        selling, and trading digital assets,
                                        integrated with blockchain technologies
                                        and social media functionalities.
                                    </p>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        Designing and deploying custom tokens on
                                        various blockchain platforms, along with
                                        building staking, swapping, and
                                        liquidity management systems for token
                                        ecosystems.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        ...
                                        and chat functionalities using
                                        technologies like Socket.io and Web3.js
                                        to enhance user interaction and
                                        experience in web applications and
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        ...
                                        applications using AI technologies like
                                        natural language processing (NLP) to
                                        improve user engagement and automate
                                        interactions.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="space-y-2 break-all">
                                    ...
                                    <p className=" leading-8 text-gray-lite dark:text-[#A6A6A6] break-normal text-justify">
                                        Developing AI-powered solutions such as
                                        recommendation engines, predictive
